...
// .wrangler/tmp/bundle-dSuY5c/checked-fetch.js
...
// .wrangler/tmp/bundle-dSuY5c/middleware-loader.entry.ts
var import_checked_fetch33 = __toESM(require_checked_fetch());

// wrangler-modules-watch:wrangler:modules-watch
var import_checked_fetch = __toESM(require_checked_fetch());

// .wrangler/tmp/bundle-dSuY5c/middleware-insertion-facade.js
var import_checked_fetch30 = __toESM(require_checked_fetch());

// .wrangler/tmp/pages-PSJ4Kd/functionsWorker-0.45657729076384224.mjs
...
var GoogleGenerativeAIError;
var GoogleGenerativeAIResponseError;
var GoogleGenerativeAIFetchError;
var GoogleGenerativeAIRequestInputError;
var DEFAULT_BASE_URL;
var DEFAULT_API_VERSION;
var PACKAGE_VERSION;
var PACKAGE_LOG_HEADER;
var Task;
var RequestUrl;
...
var init_dist = __esm({
  "../node_modules/@google/generative-ai/dist/index.mjs"() {
    ...
    import_checked_fetch3 = __toESM2(require_checked_fetch2(), 1);
...
var import_checked_fetch22;
var LLMService;
var init_llm = __esm({
  "api/lib/llm.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch22 = __toESM2(require_checked_fetch2(), 1);
    init_dist();
    LLMService = class {
      static {
...
var import_checked_fetch32;
var KnowledgeBase;
var init_knowledge = __esm({
  "api/lib/knowledge.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch32 = __toESM2(require_checked_fetch2(), 1);
    KnowledgeBase = class {
      static {
        __name(this, "KnowledgeBase");
      }
      static {
        __name2(this, "KnowledgeBase");
      }
      services = [];
      personas = [];
      policies = [];
...
var init_contextManager = __esm({
  "api/lib/contextManager.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch4 = __toESM2(require_checked_fetch2(), 1);
    contexts = /* @__PURE__ */ new Map();
    CONTEXT_TTL = 30 * 60 * 1e3;
    MAX_CONTEXTS = 1e3;
    CLEANUP_INTERVAL = 5 * 60 * 1e3;
    lastCleanup = Date.now();
    __name2(autoCleanup, "autoCleanup");
    ContextManager = class {
      static {
        __name(this, "ContextManager");
      }
      static {
        __name2(this, "ContextManager");
      }
      /**
       * 取得上下文
       */
...
var knowledgeBaseInstance;
var init_responseTemplates = __esm({
  "api/lib/responseTemplates.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch5 = __toESM2(require_checked_fetch2(), 1);
    knowledgeBaseInstance = null;
    __name2(setKnowledgeBase, "setKnowledgeBase");
    __name2(getComplaintTemplate, "getComplaintTemplate");
    __name2(getHandoffTemplate, "getHandoffTemplate");
    __name2(getApiErrorTemplate, "getApiErrorTemplate");
    __name2(getTimeoutTemplate, "getTimeoutTemplate");
    __name2(getLineInquiryTemplate, "getLineInquiryTemplate");
  }
});
var import_checked_fetch6;
var Pipeline;
var init_pipeline = __esm({
  "api/lib/pipeline.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch6 = __toESM2(require_checked_fetch2(), 1);
    Pipeline = class {
      static {
...
var init_validate_request = __esm({
  "api/nodes/01-validate-request.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch7 = __toESM2(require_checked_fetch2(), 1);
    __name2(buildCorsHeaders, "buildCorsHeaders");
    __name2(node_validateRequest, "node_validateRequest");
  }
});
...
var init_initialize_services = __esm({
  "api/nodes/02-initialize-services.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch8 = __toESM2(require_checked_fetch2(), 1);
    init_responseTemplates();
    init_chat();
    __name2(node_initializeServices, "node_initializeServices");
  }
});
...
var init_context_management = __esm({
  "api/nodes/03-context-management.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch9 = __toESM2(require_checked_fetch2(), 1);
    __name2(node_contextManagement, "node_contextManagement");
  }
});
...
var init_intent_extraction = __esm({
  "api/nodes/04-intent-extraction.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch10 = __toESM2(require_checked_fetch2(), 1);
    init_chat();
    __name2(node_intentExtraction, "node_intentExtraction");
  }
});
...
var init_state_transition = __esm({
  "api/nodes/05-state-transition.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch11 = __toESM2(require_checked_fetch2(), 1);
    __name2(node_stateTransition, "node_stateTransition");
  }
});
...
var init_special_intents = __esm({
  "api/nodes/06-special-intents.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch12 = __toESM2(require_checked_fetch2(), 1);
    init_chat();
    init_responseTemplates();
    __name2(node_specialIntents, "node_specialIntents");
  }
});
...
var init_faq_check = __esm({
  "api/nodes/07-faq-check.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch13 = __toESM2(require_checked_fetch2(), 1);
    init_chat();
    __name2(node_faqCheck, "node_faqCheck");
  }
});
...
var import_checked_fetch14;
var TIMEOUT_MS;
var init_llm_generation = __esm({
  "api/nodes/08-llm-generation.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch14 = __toESM2(require_checked_fetch2(), 1);
    init_responseTemplates();
    TIMEOUT_MS = 1e4;
    __name2(node_llmGeneration, "node_llmGeneration");
  }
});
...
var init_build_response = __esm({
  "api/nodes/09-build-response.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch15 = __toESM2(require_checked_fetch2(), 1);
    init_chat();
    __name2(node_buildResponse, "node_buildResponse");
  }
});
...
var init_error_handler = __esm({
  "api/nodes/99-error-handler.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch16 = __toESM2(require_checked_fetch2(), 1);
    init_responseTemplates();
    __name2(handlePipelineError, "handlePipelineError");
  }
});
...
var init_nodes = __esm({
  "api/nodes/index.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch17 = __toESM2(require_checked_fetch2(), 1);
...
__export(chat_pipeline_exports, {
  onRequestPostPipeline: /* @__PURE__ */ __name(() => onRequestPostPipeline, "onRequestPostPipeline")
});
...
var init_chat_pipeline = __esm({
  "api/chat-pipeline.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch18 = __toESM2(require_checked_fetch2(), 1);
    init_pipeline();
    init_nodes();
    __name2(onRequestPostPipeline, "onRequestPostPipeline");
  }
});
...
var import_checked_fetch19;
var knowledgeBase;
var llmService;
var contextManager;
var knowledgeBaseLoading;
var faqHandlingRules;
var init_chat = __esm({
  "api/chat.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch19 = __toESM2(require_checked_fetch2(), 1);
    init_llm();
    init_knowledge();
    init_contextManager();
    init_responseTemplates();
    ...
    contextManager = null;
    knowledgeBaseLoading = null;
    __name2(loadKnowledgeBase, "loadKnowledgeBase");
    __name2(initLLMService, "initLLMService");
    __name2(initContextManager, "initContextManager");
    __name2(buildResponse, "buildResponse");
    faqHandlingRules = {
      location_inquiry: {
        shouldCheckFAQ: /* @__PURE__ */ __name2(() => true, "shouldCheckFAQ")
      },
      price_inquiry: {
        shouldCheckFAQ: /* @__PURE__ */ __name2((msg) => {
          const lower = msg.toLowerCase();
          return ["\u53EF\u4EE5\u8DDF\u6211\u8AAA\u5230", "\u8AAA\u5230\u591A\u7D30", "\u54EA\u4E9B\u4E00\u5B9A\u8981", "\u518D\u554F\u771F\u4EBA", "\u5831\u50F9\u7BC4\u570D"].some((k) => lower.includes(k));
        }, "shouldCheckFAQ"),
        faqFilter: /* @__PURE__ */ __name2((faq) => faq.critical && faq.id === "policy_price_scope", "faqFilter")
      },
      booking_inquiry: {
        shouldCheckFAQ: /* @__PURE__ */ __name2((msg) => {
          const lower = msg.toLowerCase();
        ...
        faqFilter: /* @__PURE__ */ __name2((faq, message) => {
    ...
    __name2(handleFAQIfNeeded, "handleFAQIfNeeded");
    __name2(classifyIntent, "classifyIntent");
    __name2(extractEntityByPatterns, "extractEntityByPatterns");
    __name2(extractEntities, "extractEntities");
    __name2(getSuggestedQuickReplies, "getSuggestedQuickReplies");
...
__name(loadKnowledgeBase2, "loadKnowledgeBase2");
...
var import_checked_fetch20;
var knowledgeBase2;
var knowledgeBaseLoading2;
var init_faq_menu = __esm({
  "api/faq-menu.ts"() {
    init_functionsRoutes_0_37336205855784055();
    import_checked_fetch20 = __toESM2(require_checked_fetch2(), 1);
    init_knowledge();
    knowledgeBase2 = null;
    knowledgeBaseLoading2 = null;
    __name2(loadKnowledgeBase2, "loadKnowledgeBase");
...
@google/generative-ai/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.45657729076384224.js.map
